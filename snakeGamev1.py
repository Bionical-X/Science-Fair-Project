...
while True:
        ...
        #fruit ahead
        if (direction == 'UP' and snake_position[1]>fruit_position[1]) or (
                direction=='LEFT' and snake_position[0]>fruit_position[0]) or(
                direction=='DOWN' and snake_position[1]<fruit_position[1]) or(
                direction=='RIGHT' and snake_position[0]<fruit_position[0]):
                state[3] = 1

        #fruit left
        if (direction == 'UP' and snake_position[0]>fruit_position[0]) or (
                direction=='LEFT' and snake_position[1]<fruit_position[1]) or(
                direction=='DOWN' and snake_position[0]<fruit_position[0]) or(
                direction=='RIGHT' and snake_position[1]>fruit_position[1]):
                state[4] = 1
